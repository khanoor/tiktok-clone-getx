...
import 'package:tiktok/controllres/video_controller.dart';
import 'package:tiktok/views/screens/comment_screen.dart';
import 'package:tiktok/views/widgets/ciecle_animation.dart';
...
class VideoScreen extends StatelessWidget {
  ...
  buildMusicsAlbum(String profilePhoto) {
    return SizedBox(
      width: 60,
      height: 60,
      child: Column(
                        ...
                        Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              CircleAnimation(
                                  child: buildMusicsAlbum(data.profilePhoto))
                            ],
                          ),
                        )
                      ],
